module MathFunctions
    ...
    FiniteDifferenceCyl, FiniteSecondDifferenceCyl, 
    ExpandForGhostPoints2DSoA,
    PBCDeriv2DSoA, DirDeriv2DSoA, NeuDeriv2DSoA, NeuDerivCylSoA, BCDerivDict,
    ...
    function NeuDerivCylSoA(vals, derivFunc)
        newVals = ExpandForGhostPointsCylSoA(vals)
        deriv = derivFunc(newVals)
        return deriv[2:end-1, 1]
    end
